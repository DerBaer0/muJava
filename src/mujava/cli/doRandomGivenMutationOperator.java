...
/**
 * <p>
 * Description: The Class doRandomGivenMutationOperator. Overview: This class is used to calculate
 * mutation scores based on randomly generated adequate test set of given mutation operators.
 * Experiment use only.
 * </p>
 *
 * @author Lin Deng
...
public class doRandomGivenMutationOperator {
  ...
  public static void main(String[] args) throws IOException {
    ...
    // if no target is selected, randomly take one tes
    ...
    HashMap<String, ArrayList<String>> filtered_data =
        getFilteredDataBasedOnTargets(result, targets);

    // get the adequate test set
    // CopyOnWriteArrayList<ArrayList<String>> adequateTestSet = getAdequateTestSets4(filtered_data,
    // testNames);
  ...
  private static void writeResultToFiles(ArrayList<Pair> mutationScores, String resultPath,
      ArrayList<String> targets) throws UnsupportedEncodingException, IOException {
